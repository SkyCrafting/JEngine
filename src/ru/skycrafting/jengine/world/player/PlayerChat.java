...
public class PlayerChat {
    ...
    public void addChatHistoryMessage() {
        addChatMessage(Color.green.getRGB(), p.getName(), chatMsg);
        newMsg++;
        max = Collections.max(chatList, Comparator.comparing(s -> s.length()));
        instance.getNetManager().sendChatMessage(chatMsg);
    }

    public void addChatMessage(int color, String name, String msg) {
